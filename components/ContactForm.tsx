...
export default function ContactForm()
{
    return (
        <div className='padding-container w-full '>
            ...
            <form className='flex flex-1  flex-col gap-5 lg:max-w-[600px] mt-6'>
                <Input type='text' placeholder='Nome' />
                <Input type='email' placeholder='Email' />
                <Input type='number' placeholder='Celular' />
                <Textarea rows={5} placeholder='Digite sua mensagem' />
                <Button size={"lg"} className='mt-3'>Envie sua mensagem</Button>
            </form>
            <div className='mt-8 flex flex-col sm:flex-row gap-3 md:gap-8'>
